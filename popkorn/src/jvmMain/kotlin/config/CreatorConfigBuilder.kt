...
/**
 * Extra configurations to be used when creating an instance from JVM
 *
 * @author Pau Corbella
 * @since 2.1.0
 */
class CreatorConfigBuilder {
    ...
    fun <T : Any> assist(instance: T, type: Class<out T>, environment: String): CreatorConfigBuilder {
        assisted.add(Instance(instance, type.kotlinClass(), environment))
        return this
    }

    fun <T : Any> assist(instance: T, type: Class<out T>): CreatorConfigBuilder {
    ...
    fun <T : Any> override(instance: T, type: Class<out T>, environment: String): CreatorConfigBuilder {
        overridden.add(Instance(instance, type.kotlinClass(), environment))
        return this
    }

    fun <T : Any> override(instance: T, type: Class<out T>): CreatorConfigBuilder {
