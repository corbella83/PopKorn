...
class TestAssistedClass2Provider : Provider<TestAssistedClass2> {
    override fun create(injector: InjectorManager, environment: String?): TestAssistedClass2 = TestAssistedClass2(injector.inject(String::class, "env1"), injector.inject(String::class, "env2"), environment)
