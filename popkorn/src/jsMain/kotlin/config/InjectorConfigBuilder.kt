...
/**
 * Extra configurations to be used when injecting an instance from JS
 *
 * @author Pau Corbella
 * @since 2.1.0
 */
class InjectorConfigBuilder {
    ...
    fun <T : Any> assist(instance: T, type: JsClass<out T>, environment: String): InjectorConfigBuilder {
        assisted.add(Instance(instance, type.kotlinClass(), environment))
        return this
    }

    fun <T : Any> assist(instance: T, type: JsClass<out T>): InjectorConfigBuilder {
